            ...
            <div class="relative rounded-2xl bg-white ring-1 ring-stone-200 p-5 shadow-sm min-h-[120px] flex flex-col justify-between">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="mt-2 text-xl font-extrabold">Vitamin xyzz</h3>
                        <p class="mt-1 text-xs text-stone-600">+100 penjualan minggu ini</p>
                    </div>
            ...
            <div class="relative rounded-2xl bg-white ring-1 ring-stone-200 p-5 shadow-sm min-h-[120px] flex flex-col justify-between">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="mt-2 text-xl font-extrabold">65</h3>
            ...
            <div class="relative rounded-2xl bg-white ring-1 ring-stone-200 p-5 shadow-sm min-h-[120px] flex flex-col justify-between">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="mt-2 text-xl font-extrabold">4</h3>
